...
function App() {
  ...
  async function generateAnswer() {
    ...
    try {
      ...
      setTimeout(() => {
        axios({
          url: 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAoP9eQESTdI4eQzPf9m19YfSHINbOQdv8',// Use your actual API key here
          method: 'post',
          data: {
